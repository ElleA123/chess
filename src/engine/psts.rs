...
use crate::chess::{Color, Square, NUM_SQUARES, Piece, NUM_PIECES};
...
static PSTS_MG: [[isize; NUM_SQUARES]; NUM_PIECES] = {
    ...
    let board_aligned = PSTS_MG_ALIGNED_PRETTY;
...
const PSTS_MG_ALIGNED_PRETTY: [[isize; NUM_SQUARES]; NUM_PIECES] = [
    // Rook
