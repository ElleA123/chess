...
use crate::bchess::{color::Color, square::{Square, NUM_SQUARES}, piece::{Piece, NUM_PIECES}};
...
static PSTS_MG: [[isize; NUM_SQUARES]; NUM_PIECES] = {
    ...
    let board_aligned = BOARD_ALIGNED;
...
// PSTs aligned such that a1 is the bottom left
const BOARD_ALIGNED: [[isize; NUM_SQUARES]; NUM_PIECES] = [
    // Rook
